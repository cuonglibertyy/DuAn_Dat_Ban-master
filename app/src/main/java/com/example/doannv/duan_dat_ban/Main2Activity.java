...
import com.example.doannv.duan_dat_ban.model.QLViewPage;
import com.example.doannv.duan_dat_ban.model.ViewPage;
...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabDatban.getTabAt(0).setText("Bưa trưa");
        tabDatban.getTabAt(1).setText("Bưa tối");
        ActionToolbar();
