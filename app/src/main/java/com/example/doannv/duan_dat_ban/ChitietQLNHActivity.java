...
public class ChitietQLNHActivity extends AppCompatActivity {
    ...
    private void SKText() {
        ...
        tvDiachitiet.setText("Đia chỉ: "+diachi);
        tvMonanchiet.setText("Món ăn: "+monan);
        tvGiatien.setText("Giá thành: "+tien+"K /"+" 1 người");
        tvbantrong.setText("Nhà hàng còn 2 bàn trống");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.itemXoaNH:
                ...
                builder.setMessage("Bạn có muốn xóa nhà hàng không");
