...
import com.example.doannv.duan_dat_ban.ChitietActivity;
...
import com.example.doannv.duan_dat_ban.NhaHang2Activity;
...
public class BuatruaFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.bua_trua,container,false);
        recyBuaTrua = view.findViewById(R.id.recyBuaTrua);
