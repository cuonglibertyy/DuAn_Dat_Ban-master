...
public class DangKyActivity extends AppCompatActivity {
    ...
    private TextInputEditText edtDKUser;
    private TextInputLayout layoutDKpass;
    private TextInputEditText edtDKpass;
    private TextInputLayout layoutNLpass;
    private TextInputEditText edtNLpass;
    ...
    private void AnhXa() {
        ...
        edtDKUser = (TextInputEditText) findViewById(R.id.edt_DKUser);
        layoutDKpass = (TextInputLayout) findViewById(R.id.layout_DKpass);
        edtDKpass = (TextInputEditText) findViewById(R.id.edt_DKpass);
        layoutNLpass = (TextInputLayout) findViewById(R.id.layout_NLpass);
        edtNLpass = (TextInputEditText) findViewById(R.id.edt_NLpass);
