...
public class DoiMKActivity extends AppCompatActivity {
    ...
    private TextInputEditText edtMKHT;
    private TextInputLayout layoutMKL1;
    private TextInputEditText edtMKL1;
    private TextInputLayout layoutMKL2;
    private TextInputEditText edtMKL2;
    ...
    private void AnhXa() {
        ...
        edtMKHT = (TextInputEditText) findViewById(R.id.edt_MKHT);
        layoutMKL1 = (TextInputLayout) findViewById(R.id.layout_MKL1);
        edtMKL1 = (TextInputEditText) findViewById(R.id.edt_MKL1);
        layoutMKL2 = (TextInputLayout) findViewById(R.id.layout_MKL2);
        edtMKL2 = (TextInputEditText) findViewById(R.id.edt_MKL2);
